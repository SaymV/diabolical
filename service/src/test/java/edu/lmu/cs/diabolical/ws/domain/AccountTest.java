...
public class AccountTest {
    ...
    public void setUp() {
        ...
        sampleAccount = new Account(null, null, null, null, null, sampleCharacterRoster);
    }

    @Test
    public void testAccountConstructor() {
        Account a = new Account(23L, "first", "last", "myname", "ABCDEFG123", new ArrayList<Character>());
